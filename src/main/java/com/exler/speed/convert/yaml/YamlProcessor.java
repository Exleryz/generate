...
public abstract class YamlProcessor {
    ...
    private List<YamlProcessor.DocumentMatcher> documentMatchers;
...
//            log.info("Merging document (no matchers set): " + map);
...
//                            log.info("Matched document with default matcher: " + map);

                        callback.process(properties, map);
                        return true;
                    }

//                    log.info("Unmatched document: " + map);
...
//            log.info("Matched document with document matcher: " + properties);
